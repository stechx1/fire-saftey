    ...
    <>
         <div className=' pt-5 container text-center '>
            ...
            <div className=' pt-5 container ' style={{ paddingRight: '15%', fontSize: '14px' }}>
                ...
                <p className={`${headingStyles.smallpara} py-2 `}>We currently offer the courses: </p>
                <div className='d-flex flex-column gap-2 px-5 my-3 text-muted'>
                    <span style={{ fontSize: "14px", color:'black' }}>
                        <i style={{ fontSize: '14px', color:'#C32128' }} className="fa fa-check-circle me-2 " aria-hidden="true"></i>
