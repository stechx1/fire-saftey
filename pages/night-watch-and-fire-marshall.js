  ...
  return (
    <>
      <div className={`container ${headingStyles.mainContainer} `}>
        ...
        <p className={headingStyles.smallpara}>If you need a Fire Marshal for a night club, a product launch, or a 24 hour watch on a high rise, Red Fire Safety can help. Our Fire Marshal services have been utilized at a variety of large sporting events, TV studios, festivals, product launches, and even night clubs over the years. </p>
        <p className={headingStyles.smallpara}>Some of our high profile events have included product launches in London&apos;s west end with indoor and  outdoor sporting events such as the London 2012 Olympics. </p>
        <p className={headingStyles.smallpara}>Our Fire Marshals can be supplied in our standard branded workwear or we can ensure they are dressed formally and discreetly for high profile events. </p>
        <p className={headingStyles.smallpara}>We pride ourselves on only supplying Fire Marshalls alongside serving Firefighters, which gives our clients that extra peace of mind. As professionals, our staff react calmly and proactively to highly stressful situations. They are experienced in evacuations, roll calls, and, of course, attempt to put out fires.  </p>
        </div>
        <div className="right w-100 d-flex justify-content-center align-items-center ">
          <img src='/SVGs/Night watch - Fire marshal services.svg' alt="Fire Alarm Servicing" className='img-fluid' style={{ width: '40%' }} />
        </div>
      </div>
      <div className="pt-2">
        <Featurebox reverse={true} secHeading="" pHeading="" paras={['Event fire marshals offer the following benefits:']} points={['A responsible person to ensure all escape routes and exits are clear. ', 'Ensuring all firefighting equipment and alarm systems are in working order. ', 'Identifying hazards and reporting findings to rectify the hazard during watch or as soon and practicably possible.  ', 'Dedicated responsible person to investigate any alarm actuation and initiate the evacuation of the premises if required. ', 'Will attempt to extinguish any fire situation if safe to do so. ', 'Carry out a roll call at the assembly point to ensure all persons are accounted for.  ', 'Main point of contact for the fire & emergency services.  ']} image="/Images/fire-marshall.jpeg" />
      </div>
